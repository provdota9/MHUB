...
local function GetSave (valueName)
	...
	if value == nil then
		if DefaultFiles['Skele Hub\\BF\\Settings_' .. player.Name .. '.json'][valueName] ~= nil then
			Save(valueName, DefaultFiles['Skele Hub\\BF\\Settings_' .. player.Name .. '.json'][valueName])
		else
...
MakeNewPage('Stats', 0.225)
MakeNewPage('Fruit', 0.14)
MakeNewPage('Shop', 0.1)
---------------------------------------
...
AutoBusoH = MakeCheckbox(Main_MainSubPage, 'Auto BUSO haki', 0.056)
AutoKenH = MakeCheckbox(Main_MainSubPage, 'Auto KEN haki', 0.056)
AutoRaceABL = MakeCheckbox(Main_MainSubPage, 'Auto use race ability', 0.056)
AutoRaceAWK = MakeCheckbox(Main_MainSubPage, 'Auto use V4', 0.056)
